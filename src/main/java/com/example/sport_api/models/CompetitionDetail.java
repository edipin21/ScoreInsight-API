...
public class CompetitionDetail extends Competition {
    ...
    @OneToMany(mappedBy = "competitionDetail", cascade = CascadeType.ALL, fetch = FetchType.EAGER)
    ...
    public CompetitionDetail(int competitionId, String areaName, String name, String gender, String type, String format,
            String stringKey, Area area, List<Season> seasons) {
        super(competitionId, areaName, name, gender, type, format, stringKey, area, seasons);

...
public class ConsensusOutcome {
    ...
    @Id
    private int ConsensusOutcomeId;
    private int NumberOfSportsbooks;
    ...
    public ConsensusOutcome(int consensusOutcomeId, int numberOfSportsbooks, int bettingOutcomeID, int bettingMarketID,
    ...
    public int getConsensusOutcomeId() {
        return ConsensusOutcomeId;
    }

    public void setConsensusOutcomeId(int consensusOutcomeId) {
        ConsensusOutcomeId = consensusOutcomeId;
    }

    public int getNumberOfSportsbooks() {
        return NumberOfSportsbooks;
    }

    public void setNumberOfSportsbooks(int numberOfSportsbooks) {
        NumberOfSportsbooks = numberOfSportsbooks;
    }

...
// competitionController.retrieveCompetitionById(competitionId);
...
// ResponseEntity<Competition> response =
// competitionController.retrieveCompetitionById(1);
...
// // Arrange
// int competitionId = -1;
// when(competitionService.getCompetitionById(competitionId)).thenThrow(new
...
// @Test
// void
// testRetrieveCompetitionById_DataAccessException_ReturnsInternalServerError()
// {
// // Arrange
// int competitionId = 1;
// when(competitionService.getCompetitionById(competitionId))
// .thenThrow(new DataAccessResourceFailureException("Database connection
// error"));
